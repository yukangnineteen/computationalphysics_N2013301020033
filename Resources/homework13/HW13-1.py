...
class ELECTRIC_FIELD(object):
    ...
    def plot_3d(self,ax,x1,x2,y1,y2):   # give 3d plot the potential
        ...
        self.surf=ax.plot_surface(self.x,self.y,self.V, rstride=1, cstride=1, cmap='hot')
        ax.set_xlim(x1,x2)
        ax.set_ylim(y1,y2)
        ...
        # ax.contourf(self.x,self.y,self.V, zdir='z', offset=-1.2, cmap=plt.cm.hot)
        ax.set_title('Electric potential distribution near two metal plates',fontsize=18)

...
plot(x1,y1,label=r'$\omega = 0 rps$')
plot(x2,y2,label=r'$\omega = 100 rps$')
plot(x3,y3,label=r'$\omega = 500 rps$')
plot(x4,y4,label=r'$\omega = 1000 rps$')
plot(x5,y5,label=r'$\omega = 2000 rps$')
...
# legend(loc='right',frameon=False)

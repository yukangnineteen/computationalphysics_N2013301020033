...
def initialize_body_list(body_list):
    sun = Body(x=300, y=300, r=50, mass=3000, color=(200, 200, 0))
    sun.vx = 0
    sun.vy = 0
    sun.ax = 0
    sun.ay = 0
    ...
    mercury = Body(x=400, y=300, r=10, mass=35, color=(255, 50, 50))
    mercury.vx = 0
    mercury.vy = 60
    mercury.ax = 0
    mercury.ay = 0
    ...
    earth = Body(x=500, y=300, r=15, mass=50, color=(25, 50, 255))
    earth.vx = 0
    earth.vy = 40
    earth.ax = 0
    earth.ay = 0
